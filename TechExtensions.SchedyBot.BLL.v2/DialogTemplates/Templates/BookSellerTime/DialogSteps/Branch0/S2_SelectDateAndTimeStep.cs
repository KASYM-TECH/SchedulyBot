...
{
    public class S2_SelectDateAndTimeStep : IDialogStep
    {
        ...
        public S2_SelectDateAndTimeStep(
        ...
        // TODO: Возможно алгоритм можно будет переиспользовать, поэтому вынести бы его в хэлпер какой
