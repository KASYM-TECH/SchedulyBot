...
{
    public class S2_LastNameInputStep : IDialogStep
    {
        private string _messageTag = "branch0step2mess";
        private string _errorTag = "branch0EnterErr";
        private string _skipButtonTag = "branch0step2btn1";
