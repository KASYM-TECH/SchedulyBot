...
{
    public class S13_DetermineLunchTimeFromStep : IDialogStep
    {
        private string _messageTag = "branch0step13mess";
        ...
        public S13_DetermineLunchTimeFromStep(IMessageTranslationManger messageTranslationManger,
        ...
        public async Task SendReplyToUser()
        {
            ...
            var markup = await TimeInputInlineKeyBoard.Launch(_messageTranslationManger, "13:00");
        ...
        public async Task<DialogIteration?> HandleAnswerAndGetNextIteration(string clientAnswer)
        {
            ...
            if (handleResult.result != null)
            {
                ...
                schedules.ForEach(s => s.BreakTimeFrom = DateTime.ParseExact(handleResult.result, _timeFormats, null));
