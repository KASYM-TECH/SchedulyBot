...
{
    public class S14_DetermineLunchTimeToStep : IDialogStep
    {
        private string _messageTag = "branch0step14mess";
        ...
        public S14_DetermineLunchTimeToStep(IMessageTranslationManger messageTranslationManger,
        ...
        public async Task SendReplyToUser()
        {
            ...
            var markup = await TimeInputInlineKeyBoard.Launch(_messageTranslationManger, "14:00");
        ...
        public async Task<DialogIteration?> HandleAnswerAndGetNextIteration(string clientAnswer)
        {
            ...
            if (handleResult.result != null)
            {
                ...
                schedules.ForEach(s => s.BreakTimeTo = DateTime.ParseExact(handleResult.result, _timeFormats, null));
